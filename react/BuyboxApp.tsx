...
BuyboxApp.schema = {
  ...
  properties: {
    conditionalStrategy: {
      ...
      properties: {
        sortStrategy: {
          ...
          enumNames: [
            'admin/buybox-context.price.label',
            'admin/buybox-context.price-and-shipping.label',
            'admin/buybox-context.custom-expression',
            'admin/buybox-context.protocol',
          ],
        },
      },
      dependencies: {
    ...
    triggerCepChangeEvent: {
      ...
      enumNames: [
        'admin/buybox-context.order-form.label',
        'admin/buybox-context.seller-selector.label',
      ],
      default: 'orderForm',
    },
  },
